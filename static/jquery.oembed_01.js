...
(function ($) {
    ...
    $.fn.oembed.defaults = {
        fallback: true,
        maxWidth: 500, //DS 24/6/2015 Added maxwidth... no change
        maxHeight: null,
        includeHandle: true,
        embedMethod: 'auto',
        // "auto", "append", "fill"
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("instagram", "photo", ["instagr\\.?am(\\.com)?/.+"], "//api.instagram.com/oembed", {maxwidth: 500}), //DS 24/6/2015 Added maxwidth... no change
